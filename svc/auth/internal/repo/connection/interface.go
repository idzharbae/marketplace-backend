...
//go:generate mockgen -destination=gormmock/connection.go -package=gormmock github.com/idzharbae/marketplace-backend/svc/auth/internal/repo/connection Gormw
